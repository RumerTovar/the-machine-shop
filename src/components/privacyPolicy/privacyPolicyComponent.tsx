...
export default function PrivacyPolicyComponent() {
 return (
  <div className={`${outfit.className} ${styles.container}`}>
   ...
   Si después de aceptar cambia de opinión, puede retirar su consentimiento para
   que nos comuniquemos con usted, para la recopilación, uso o divulgación
   ...
   <br />
   Podemos divulgar su información personal si la ley nos exige que lo hagamos o
   si viola nuestros Términos de servicio. <br />
   <br />
   ...
   En particular, recuerde que ciertos proveedores pueden estar ubicados o tener
   instalaciones ubicadas en una jurisdicción diferente a la suya o la
   ...
   puede quedar sujeta a las leyes de las jurisdicciones en las que se encuentra
   ese proveedor de servicios o sus instalaciones.
   <br />
   ...
   Google analitico:
   <br />
   Nuestra tienda utiliza Google Analytics para ayudarnos a conocer quién visita
   nuestro sitio y qué páginas se consultan <br />
   <br />
   ...
   destruido. <br />
   Si nos proporciona la información de su tarjeta de crédito, la información se
   cifra mediante la tecnología de capa de conexión segura (SSL) y se almacena
   con un cifrado AES-256.Si bien ningún método de transmisión a través de
   Internet o almacenamiento electrónico es 100 % seguro, seguimos todos los
   requisitos de PCI-DSS e implementamos estándares adicionales de la industria
   ...
   sin datos retenidos, vence a la medianoche (en relación con el visitante) del
   día siguiente, cuenta el número de visitas a una tienda por un solo cliente.{' '}
   <br />
   ...
   <br />
   storefront_digest, token único, indefinido Si la tienda tiene una contraseña,
   esta se usa para determinar si el visitante actual tiene acceso. <br />
   ...
   <br />
   Al usar este sitio, usted declara que tiene al menos la mayoría de edad en su
   estado o provincia de residencia , o que tiene la mayoría de edad en su
   ...
   cualquier momento, así que revísela con frecuencia.Los cambios y aclaraciones
   entrarán en vigor inmediatamente después de su publicación en el sitio web.Si
   hacemos cambios sustanciales a esta política, le notificaremos aquí que ha
   sido actualizada, para que sepa qué información recopilamos, cómo la usamos y
   bajo qué circunstancias, si las hay, usamos y/o divulgamos él. <br />
