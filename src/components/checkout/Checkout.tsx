   ...
   <main>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
     ...
     <div className={styles.inputGroup}>
      <label className={styles.label}>Pais/Region</label>
     ...
     <input type='text' name='zipCode' id='' className={styles.input} />
     <input type='text' name='phone' id='' className={styles.input} />
