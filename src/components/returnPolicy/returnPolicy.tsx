...
export default function ReturnPolicyComponent() {
 return (
  <div className={`${outfit.className} ${styles.container}`}>
   ...
   su compra, lamentablemente no podemos ofrecerle un reembolso o cambio. <br />
   <br />
   ...
   electrónico para notificarle que hemos recibido su artículo devuelto. También
   le notificaremos la aprobación o rechazo de su reembolso. <br />
   ...
   themachineshop@gmail.com y envíe su artículo a: Jose Antonio de Goyechea 2851
