...
export default function ShippingPolicyComponent() {
 return (
  <div className={`${outfit.className} ${styles.container}`}>
   ...
   <p className={styles.paragraph}>
    <strong>Tiempo de procesamiento del envío</strong>
   </p>
   <p className={styles.paragraph}>
   ...
   <p className={styles.paragraph}>
    Los gastos de envío de su pedido se calcularán y se mostrarán en el carrito.
   </p>
   <p className={styles.paragraph}>
   ...
   <p className={styles.paragraph}>
    <strong>Confirmación de envío y seguimiento de pedidos</strong>
   </p>
   <p className={styles.paragraph}>
   ...
   <p className={styles.paragraph}>
    <strong>Derechos de aduanas, aranceles e impuestos</strong>
   </p>
   <p className={styles.paragraph}>
    The Machine Shop no es responsable de las aduanas e impuestos aplicados a su
    pedido. Todas las tarifas impuestas durante o después del envío son
    responsabilidad del cliente (aranceles, impuestos, etc.).
   </p>
   <p className={styles.paragraph}>
    <strong>Daños y perjuicios</strong>
   </p>
   <p className={styles.paragraph}>
